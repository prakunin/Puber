...
internal class DetailsVM(
    ...
    override fun onAction(action: UIAction) {
        ...
        when (action) {
            ...
            is DetailsAction.SeasonSelected -> onSeasonSelected(action.number)
    ...
    private fun updateCurrentItem(
        ...
        updateViewState(
            mapped.copy(
                ...
                // The viewer may have switched season with the chips; a redraw must not undo it.
                selectedSeasonNumber = state?.selectedSeasonNumber ?: mapped.selectedSeasonNumber,
    ...
    private fun onSeasonSelected(number: Int) {
        updateViewState<DetailsScreenState.Content> { copy(selectedSeasonNumber = number) }
    }
