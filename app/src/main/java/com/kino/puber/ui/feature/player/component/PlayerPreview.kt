...
@Preview(name = "Movie — watched control unavailable", device = TV_1080p)
@Composable
private fun MovieWithoutWatchedControlPreview() = PuberTheme {
    PlayerScreenContent(
        state = PlayerViewState.Content(previewMovieContent(canMarkCurrentWatched = false)),
        onAction = {},
        exoPlayer = { null },
    )
}
