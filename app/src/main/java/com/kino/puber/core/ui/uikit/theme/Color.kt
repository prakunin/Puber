...
/**
 * The rating sources' own colours. The mark is coloured and the number stays white: on black the
 * orange holds about 4.4:1, too little for an 11sp digit, while a silhouette does not need it.
 */
val KinopoiskOrange = Color(0xFFFF6600)
