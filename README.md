...
используется для экспериментального поиска сегментов intro/credits, фотографий актёров и расписания выхода серий;
без него эти возможности будут недоступны или работать ограниченно.
